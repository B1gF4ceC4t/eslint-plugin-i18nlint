...
module.exports = {
	meta: {
		docs: {
			description:
				"Enforces Chinese characters to be translated.",
	...
	create: function (context) {
        ...
        const ignoreInConsole = typeof options.ignoreInConsole === "boolean" ? ignoreInConsole : true; 
			...
			while (node.parent) {
				if (
					...
					(node.parent.callee.name === funcName ||
						(ignoreInConsole && node.parent.callee.type === "MemberExpression" &&
